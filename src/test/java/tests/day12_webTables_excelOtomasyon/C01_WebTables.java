...
public class C01_WebTables extends TestBase {
    // bu klasik yontemin uzerinde cok durmadim, ogrenmek icin cabalamdim
    // cunku sonraki derste yani C02, C03 ve C04 class'inda bu isin daha pratik seklini yaptik
    // bu class'i ahmet hoca'dan direk kopyala-yapistir yaptim
    // burda bulunsun diye
