...
public class C03_ReadExcelTesti  {
    ...
    public void readExcelTesti() throws IOException {
        ...
        // dosyadaki bilgileri bir imput stream olarak aliyoruz,
        // yani excel dosyasinin sanal kopyasini olusturuyoruz
        FileInputStream fileInputStream = new FileInputStream(dosyaYolu);

        // bir calisma ortami olusturuyoruz, ayni defterde calismak icin temiz bir sayfa acmak gibi
        // calisma sayfasina da file imput stream bilgilerini yukluyoruz
        Workbook workbook = WorkbookFactory.create(fileInputStream);
        sayfa1 = workbook.getSheet("Sayfa1"); // bir sayfa tanimliyoruz, exceldeki sayfa yani,
        // calistigimiz excel tablosundaki(workbook), sayfa(getSheet(sayfa adi))
        ...
        int satirSayisi = sayfa1.getLastRowNum(); // row index numarasi getirir
        //burdan satirSayisi olarak gelen rakama +1 ekleyerek asil satir sayisina ulasabiliriz
    ...
    public String baskentBul(String ulkeAdi, String dilTercihi){
        ...
        for (int i = 0; i <= sayfa1.getLastRowNum() ; i++) {
            ...
            if (satirdakiUlkeAdi.equalsIgnoreCase(ulkeAdi)){ // once ulke adini buluyoruz
