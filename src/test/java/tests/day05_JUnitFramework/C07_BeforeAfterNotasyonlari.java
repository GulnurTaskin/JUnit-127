...
import java.time.Duration;
    ...
    public class C07_BeforeAfterNotasyonlari {
        ...
        WebDriver driver;
        // Butun @Test'lerde her seferinde ilk olarak calismasi icin bir @Before olusturuyoruz
        @Before
        public void setup(){
        ...
        // her @Test'den sonra da driver'in sayfayi kapatmasi icin bir @After olusturuyoruz
        @After
        public void teardown(){
            driver.quit();
        }
        @Test // farkli test methodlari olusturuyoruz, bu bir tanesi mesela..
        ...
        @Test
        public void testOtomasyonuTest(){ // bu da farkli bi test
        /*
        ...
        // bu da baska bir test . bu class'ta diger testler calisirken ona @Ignore ekledik,
        // calistirmak istemedigimiz test methodlarini bu sekilde yok sayabiliriz
        @Test @Ignore
