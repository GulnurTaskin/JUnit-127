...
public class C06_AramaTestiWebelementScreenshot extends TestBase {
    ...
    public void urunDogrulamaTesti(){
        ...
        String actualIsimKucukHarf = urunIsimElementi.getText().toLowerCase();// toLowerCase ile case sensitive yapiyoruz
        ...
        //ekran fotosu secmek icin hazir methodumuzu cagiriyoruz
