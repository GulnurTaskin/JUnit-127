...
public class C03_Cookies extends TestBase {
    @Test
    public void cookiestestleri(){

        //1- amazon anasayfaya gidin

        driver.get("https://www.amazon.com");
ReusableMethods.bekle(20); // kapca'yi manuel gecmek icin sureyi bu kadar uzattim :)
                                  // ulkedenulkeye degisiyor sanirim, baska yerdeki arkadaslarda kapca cikmamis, bende cikti
                                  // bu konuda bi garanti yok
        ...
        System.out.println("actual sayi :  "+ actualCookiesayisi);
